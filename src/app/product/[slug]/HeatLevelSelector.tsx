  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-1">
        <Flame className="h-4 w-4 text-heat animate-flame-pulse" strokeWidth={2} />
