        ...
        >
          <button
            ...
            className={cn(
              ...
              !activeSlug
                ? 'bg-gold-500 text-dark-600 border-gold-500'
                : 'bg-dark-400 text-white/80 border-dark-300 hover:border-dark-200',
            )}
          >
            All Items
          </button>
      ...
      {(q || activeSlug) && (
        <p className="text-xs text-dark-100">
          ...
          <button
            ...
            className="ml-2 text-gold-400 hover:underline font-semibold"
          >
            Clear
          </button>
        </p>
