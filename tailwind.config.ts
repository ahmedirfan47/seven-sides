...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        gold: {
          50:  '#FFF8E7', 100: '#FFEDC4', 200: '#FFD77A', 300: '#FFBD2A',
          400: '#F5A800', 500: '#E8A020', 600: '#C47C00', 700: '#9A5D00',
          800: '#6B4000', 900: '#3D2400',
        },
        teal: {
          50:  '#E6F5F7', 100: '#C0E5EA', 200: '#86C9D2', 300: '#4BABB9',
          400: '#2A9BAD', 500: '#4B9DA8', 600: '#357E8C', 700: '#235F6B',
          800: '#154248', 900: '#082528',
        },
        dark: {
          DEFAULT: '#0A0A0A',
          50:  '#F5F5F5', 100: '#E0E0E0', 200: '#3A3A3A',
          300: '#2A2A2A', 400: '#1C1C1C', 500: '#141414',
          600: '#0A0A0A', 700: '#050505',
        },
        heat: '#D63B2E',
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        'gold-strong': '0 0 0 2px rgba(232,160,32,0.5)',
      },
      keyframes: {
        fadeUp:     { from: { opacity:'0', transform:'translateY(20px)' }, to: { opacity:'1', transform:'none' } },
        fadeIn:     { from: { opacity:'0' }, to: { opacity:'1' } },
        flamePulse: { '0%,100%': { transform:'scale(1)' }, '50%': { transform:'scale(1.08)' } },
